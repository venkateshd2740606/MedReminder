#!/usr/bin/env python3
"""Generate MedReminder Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\MedReminder")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "medreminder"
TEST = APP / "src" / "test" / "java" / "com" / "medreminder"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "medreminder"
...
android {
    ...
    defaultConfig {
        applicationId = "com.medreminder.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.medreminder.data.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "medreminder-game",
    "storage_bucket": "medreminder-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.medreminder.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating MedReminder project files...")
