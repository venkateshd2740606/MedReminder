# MedReminder — Google Play Data Safety Form Reference
...
- **Users can request deletion:** Contact privacy@medreminder.game; local data cleared via app settings or uninstall
